...
> ① PROPAGATION_REQUIRED propagation_required：如果当前没有事务，就创建一个新事务，如果当前存在事务，就加入该事务，该设置是最常用的设置。
>
> ② PROPAGATION_SUPPORTS propagation_supports：支持当前事务，如果当前存在事务，就加入该事务，如果当前不存在事务，就以非事务执行。
>
> ③ PROPAGATION_MANDATORY propagation_mandatory：支持当前事务，如果当前存在事务，就加入该事务，如果当前不存在事务，就抛出异常。
>
> ④ PROPAGATION_REQUIRES_NEW propagation_required_new：创建新事务，无论当前存不存在事务，都创建新事务。
>
> ⑤ PROPAGATION_NOT_SUPPORTED propagation_not_supports：以非事务方式执行操作，如果当前存在事务，就把当前事务挂起。
>
> ⑥ PROPAGATION_NEVER propagation_never：以非事务方式执行，如果当前存在事务，则抛出异常。
>
> ⑦ PROPAGATION_NESTED propagation_nested：如果当前存在事务，则在嵌套事务内执行。如果当前没有事务，则按REQUIRED属性执行。
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020021212264438.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1RoaW5rV29u,size_16,color_FFFFFF,t_70)
...
#### [*Spring* boot*面试题*整理](https://blog.csdn.net/yuzongtao/article/details/84295732)

#### [MySQL数据库*面试题*（2020*最新版*）](https://blog.csdn.net/ThinkWon/article/details/104778621)

#### [史上最全69道*Spring**面试题*和答案_勇往直前的专栏-CSDN博客](https://blog.csdn.net/zl1zl2zl3/article/details/81865407)

#### [...*面试题*总结(超详细回答)_张维鹏的博客-CSDN博客_*spring**面试题*](https://blog.csdn.net/a745233700/article/details/80959716)

#### [Linux*面试题*（2020*最新版*）](https://blog.csdn.net/ThinkWon/article/details/104588679)

#### [*Spring* Boot 面试精讲](https://edu.csdn.net/course/detail/27171)

#### [*Spring* *面试题*汇编_读万卷书,行万里路-CSDN博客_*spring**面试题*](https://blog.csdn.net/deniro_li/article/details/79877339)

#### [*Spring*的几个经典常见*面试题*_riemann_的博客-CSDN博客_*spring**面试题*](https://blog.csdn.net/riemann_/article/details/90725121)

#### [JAVA*面试题*[秒杀/Redis/MongoDB/*Spring*Boot/*Spring*Cloud\]](https://edu.csdn.net/course/detail/23456)

#### [*spring**面试题*及答案_Janderbake的博客-CSDN博客](https://blog.csdn.net/Janderbake/article/details/102339682)

#### [*spring* 常见*面试题*_嗯哼的博客-CSDN博客_*spring**面试题*](https://blog.csdn.net/qq_35044419/article/details/88605330)

#### [史上最全*Spring* Boot*面试题*（含答案）看完就是*Spring* Boot专家！](https://blog.csdn.net/weixin_45136046/article/details/90768687)

#### [近5年来的 *Spring* 相关*面试题*整理_Java笔记-CSDN博客_*spring*相关...](https://blog.csdn.net/qq_41701956/article/details/81389067)

#### [JAVA关于*Spring* *面试题*汇总_CalvinXCui的博客-CSDN博客_java...](https://blog.csdn.net/qq_37840993/article/details/82149095)

#### [*Spring* 常见的一些*面试题*整理_温柔一刀-CSDN博客](https://blog.csdn.net/liuhouli923914981/article/details/79763814)